...
WelcomeModel fromJson(String str) => WelcomeModel.mapToModel(json.decode(str));

String toJson(WelcomeModel data) => json.encode(data.toJson());
...
class WelcomeModel {
  ...
  factory WelcomeModel.mapToModel(Map m1) => WelcomeModel(
        status: m1["status"],
